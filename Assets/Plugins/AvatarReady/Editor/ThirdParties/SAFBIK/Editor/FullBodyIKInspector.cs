...
//      - Removing empty options and misleading stuff
using UnityEditor;
using UnityEngine;
...
namespace SA
{
    public class FullBodyIKInspectorBase : Editor
    {
        ...
        static readonly string[] toolbarContents = new string[] { "Settings", "Bone", "Effector" };

        private bool showGeneral;
        private bool showBodyIK;
        private bool showLimbIK;
        private bool showHeadIK;
        ...
        void _BoneField(string boneName, ref FullBodyIK.Bone bone, bool isOptional)
        {
            ...
            var fbik = target as FullBodyIKBehaviourBase;
            EditorGUILayout.BeginHorizontal();
        ...
        void _OnInspectorGUI_Settings()
        {
            ...
            _Header("BodyIK");
            showBodyIK = EditorGUILayout.Foldout(showBodyIK, "BodyIK");
            if (showBodyIK)
            {
            ...
            _Header("LimbIK");
            showLimbIK = EditorGUILayout.Foldout(showLimbIK, "LimbIK");
            if (showLimbIK)
            {
            ...
            _Header("HeadIK");
            showHeadIK = EditorGUILayout.Foldout(showHeadIK, "HeadIK");
            if (showHeadIK)
            {
